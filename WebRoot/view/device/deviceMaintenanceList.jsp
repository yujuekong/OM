...
<html lang="en">
	...
	<body class="no-skin">
					...
					<div class="row">
						...
						<div class="col-xs-12">
							...
							<div class="row">
								<div class="col-xs-12">
									<div>
										<table id="deviceMain_list" class="table table-striped table-bordered table-hover">
											...
											<thead>
												...
												<th class="center">维护设备人</th>
												<th class="center">维护状态</th>
		...
		<script src="${pageContext.request.contextPath}/js/biz/device/deviceMaintenanceList.js"></script>
