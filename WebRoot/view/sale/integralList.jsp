            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12">
                            <table id="gameInfo_list" class="table table-striped table-bordered table-hover"
...
<script src="${pageContext.request.contextPath}/js/biz/sale/integralList.js"></script>
<script type="text/javascript">
