...
function Bmap(){
	...
	if(obj != null ){
		var point = new BMap.Point(obj[0].carLng,obj[0].carLat);
		map.centerAndZoom(point, 15);//将光谷点设置为中心点并设置地图级别

		var pointList =new Array();
		for (var i = 0; i < obj.length; i ++) {
			var point = new BMap.Point(obj[i].carLng,obj[i].carLat);
			var label = new BMap.Label("当时时间:"+obj[i].createDate +"<br/>",{offset:new BMap.Size(20,-10)});
