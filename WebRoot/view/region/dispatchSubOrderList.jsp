...
<html lang="en">
	...
	<body class="no-skin">
			...
			<div>
				<div class="breadcrumbs" id="breadcrumbs">
					...
					<ul class="breadcrumb">
						...
						<li><a href="#">配送管理</a></li>
						<li><a href="#">待处理配送单</a></li>
						<li class="active">待处理配送单列表</li>
					</ul><!-- /.breadcrumb -->
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="row">
											...
											<thead>
												...
												<th class="center">
													<label class="position-relative">
														<input type="checkbox" name="multiple" class="ace" id="checkid" />
														<span class="lbl"></span>
													</label>
												</th>
								...
								<div id="choise_goods_action" class="col-xs-12" style="text-align:left;margin-top:10px;">
									<a id="choise_submit" class="btn btn-sm no-border btn-primary disabled" 
									   onclick="addOrder()">合成任务单</a>
								</div>
							</div><!-- /.row -->
						</div><!-- /.col -->
					</div><!-- /.row -->
		...
		<script src="${pageContext.request.contextPath}/js/biz/region/dispatchSubOrderList.js"></script>
