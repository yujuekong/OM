...
<html lang="en">
	...
	<body class="no-skin">
			...
			<div>
				<div class="breadcrumbs" id="breadcrumbs">
					...
					<ul class="breadcrumb">
						...
						<li><a href="#">车辆管理</a></li>
						<li><a href="#">车辆调度管理</a></li>
						<li class="active">车辆调度列表</li>
					</ul>
				...
				<div class="page-content">
					...
					<div class="col-xs-10">
							...
							<div class="row">
								...
								<div class="col-xs-12">
									<div>
										<table id="carDispatch_list" class="table table-striped table-bordered table-hover">
											<thead>
												<tr>
												<th class="center">车辆调度ID</th>
												<th class="center">车牌号</th>
												<th class="center">车辆品牌</th>
												<th class="center">开车司机</th>
												<th class="center">始发地</th>
												<th class="center">调度日期</th>
		...
		<script src="${pageContext.request.contextPath}/js/biz/car/carDispatchList.js"></script>
	</body>
</html>
