...
<html lang="en">
	...
	<body class="no-skin">
				...
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="row">
								<div class="col-xs-12">
									<table id="userOp_list" class="table table-striped table-bordered table-hover"  
									style="text-align: center">
										<thead>
											<tr>
												...
												<th class="center">处理事件</th>
												<th class="center">处理结果</th>
												<th class="center">业务操作原因</th>
		...
		<script src="${pageContext.request.contextPath}/js/biz/region/serviceUserOpList.js"></script>
	</body>
</html>
