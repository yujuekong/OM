									...
									<table id="sample-table-1" class="table table-striped table-bordered table-hover">
										...
										<tbody>
											<tr>
												...
												<td class="center"><span class="label label-sm label-error">审核不通过</span></td>
												<td class="center">
													<div class="hidden-sm hidden-xs btn-group">
														<a href="${pageContext.request.contextPath}/view/yy/yyGoodsView.jsp"  class="tooltip-info" data-rel="tooltip" title="查看">
															<button class="btn btn-xs btn-success">
																<i class="ace-icon fa fa-search-plus bigger-120"></i>
															</button>
														</a>
														<a href="${pageContext.request.contextPath}/view/yy/yyGoodsEdit.jsp"  class="tooltip-info" data-rel="tooltip" title="编辑">
											...
											<tr>
												...
												<td class="center">2015-08-10</td>
												<td class="center">2015-08-10 10:00</td>												
												<td class="center"><span class="label label-sm label-success">审核通过</span></td>
												<td class="center">
													<div class="hidden-sm hidden-xs btn-group">
														<a href="${pageContext.request.contextPath}/view/yy/yyGoodsView.jsp"  class="tooltip-info" data-rel="tooltip" title="查看">
															<button class="btn btn-xs btn-success">
											...
											<tr>
												...
												<td class="center">2015-08-10</td>
												<td class="center">2015-08-10 10:00</td>												
												<td class="center"><span class="label label-sm label-warning">审核中</span></td>
												<td class="center">
													<div class="hidden-sm hidden-xs btn-group">
														<a href="${pageContext.request.contextPath}/view/yy/yyGoodsView.jsp"  class="tooltip-info" data-rel="tooltip" title="查看">
															<button class="btn btn-xs btn-success">
