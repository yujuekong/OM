...
citySelector.pc[30] = new Array("内蒙古", "呼和浩特|包头|乌海|赤峰|呼伦贝尔|通辽|乌兰察布|鄂尔多斯|巴彦淖尔");
...
citySelector.pc[29] = new Array("黑龙江", "哈尔滨|齐齐哈尔|牡丹江|佳木斯|大庆|绥化|鹤岗|鸡西|黑河|双鸭山|伊春|七台河");
...
citySelector.pc[9] = new Array("青海", "西宁|海东");
citySelector.pc[6] = new Array("新疆", "乌鲁木齐|克拉玛依");
citySelector.pc[31] = new Array("其它", "澳门|香港|台湾");

citySelector.hotCity = ["北京", "上海", "武汉", "深圳","长沙"];
