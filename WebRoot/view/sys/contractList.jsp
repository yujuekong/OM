...
<html lang="en">
	...
	<body class="no-skin">
			...
			<div>
				<div class="breadcrumbs" id="breadcrumbs">
					...
					<ul class="breadcrumb">
						...
						<li><a href="#">系统管理</a></li>
						<li><a href="#">合同管理</a></li>
						<li class="active">合同信息列表</li>
					</ul><!-- /.breadcrumb -->
					<%--<div class="nav-search" id="nav-search">--%>
						<%--<a href="${pageContext.request.contextPath}/view/sys/contractInfo.jsp" class="tooltip-info" data-rel="tooltip" title="新增">--%>
				...
				<div class="page-content">
					<div class="row">
						<!-- <div class="col-xs-2">
							<div style="height: 600px;  scroll; border: 1px solid #ddd;">
								...
								<div class="searchbar">
									<ul class="list-inline">
								     ...
								     <i class="ace-icon fa fa-search nav-search-icon"></i>
											...
											<button onclick="window.location.href='${pageContext.request.contextPath}/view/sys/contractInfo.jsp'" class="btn btn-xs btn-success">新增
											</button>&nbsp;&nbsp;&nbsp;&nbsp;
										</span>
									</ul>
		...
		<script src="${pageContext.request.contextPath}/js/biz/sys/contractList.js"></script>
	</body>
</html>
