        ...
        <div class="page-content">
            <div class="row">
                ...
                <div class="col-xs-12">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <input type="hidden" id="deliveryOrderId" value="${deliveryOrderId}">
...
<script src="${pageContext.request.contextPath}/js/biz/inventory/outDetailList.js"></script>
