                                    ...
                                    <div class="widget-main" style="float: left;width: 45%">
                                        ...
                                        <span class="input-icon input-icon-right">
                                            <%--<select name="activityCoupon.couponType" class="required control-label"--%>
                                                ...
                                                <%--</option>--%>
                                                <%--<option value="1" ${activityCoupon.couponType=="0"?"selected":""}>折扣--%>
                                                <%--</option>--%>
                                            <%--</select>--%>
                                            <input type="text" disabled
                                                   value="${activityCoupon.couponType=='0'?'现金':'折扣'}" id="activityCoupon_couponType"
                                                   class="required control-label"
                                                   style="width:250px;" name="activityCoupon.couponType"/>
                                        </span>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 no-padding-right">
