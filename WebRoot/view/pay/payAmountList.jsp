...
<html lang="en">
	...
	<body class="no-skin">
									...
									<table id="sample-table-1" class="table table-striped table-bordered table-hover">
										<thead>
											<tr>
												...
												<th class="center">所在商圈</th>
												<th class="center">消费金额</th>
												<th class="center">消费日期</th>
											</tr>
										</thead>
										...
										<tbody>
											...
											<tr>
												...
												<td class="center">光谷广场</td>										
												<td class="center">560元</td>
												<td class="center">2015-08-01</td>
											</tr>
											<tr>
												<td class="center">
		...
		<script type="text/javascript">
			$("#submenu-menu-sale-info").addClass("active");
