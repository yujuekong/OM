...
public class QuartzJob{
    ...
    public void work() {
    	...
    	//刀片更换任务
    	deviceHandler.queryDeviceByPeriod();
    }
    
    /**
     * 统计报表
     */
    public void statisticalStatement() {
    	statementHandler.statisticalStatement(DateUtil.getFristDayOfLastMonth(),DateUtil.getLastDayOfLastMonth());
    }
