...
<html lang="en">
	...
	<body class="no-skin">
			...
			<div>
				<div class="breadcrumbs" id="breadcrumbs">
					...
					<ul class="breadcrumb">
						...
						<li><a href="#">车辆管理</a></li>
						<li><a href="#">车辆信息管理</a></li>
						<li class="active">车辆信息列表</li>
					</ul><!-- /.breadcrumb -->
								...
								<div class="searchbar">
									<ul class="list-inline">
								     ...
								     <i class="ace-icon fa fa-search nav-search-icon"></i>
										...
										<tr>
											<td>
												<button onclick="allCarMap()" class="btn btn-xs btn-danger">所有车辆分布图</button>
											</td>
										</tr>
								...
								<div class="col-xs-12">
									<div>
										<%--<div class="nav-search" id="nav-search_seller">--%>
									        ...
									        <%--</span>--%>
		                                <%--</div>--%>
										<table id="carInfo_list" class="table table-striped table-bordered table-hover">
											<thead>
												<tr>
												...
												<th class="center">检验有效期</th>
												<th class="center">创建日期</th>
												<th class="center">历史轨迹</th>
		...
		<script src="${pageContext.request.contextPath}/js/biz/car/carInfoList.js"></script>
	</body>
</html>
