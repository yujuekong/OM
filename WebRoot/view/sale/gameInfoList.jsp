									...
									<table id="gameInfo_list" class="table table-striped table-bordered table-hover" style="text-align: center">
										<thead>
											<tr>
												...
												<th class="center">活动消耗类型</th>
												<th class="center">活动消耗数量</th>
												<th class="center">活动开始日期</th>
												<th class="center">活动结束日期</th>
												<th class="center">
													<select onchange="searchGameStatus()" id="gameStatus" style="border: none;">
...
<!-- page specific plugin scripts -->
		...
		<script src="${pageContext.request.contextPath}/js/biz/sale/gameInfoList.js"></script>
		<script type="text/javascript">
