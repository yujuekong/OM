...
<html lang="en">
	...
	<body class="no-skin">
											...
											<tr>
												...
												<td class="center">
													<div class="hidden-sm hidden-xs btn-group">
														<a href="${pageContext.request.contextPath}/view/yy/yyUserView.jsp"  class="tooltip-info" data-rel="tooltip" title="查看">
															<button class="btn btn-xs btn-success">
																<i class="ace-icon fa fa-search-plus bigger-120"></i>
															</button>
														</a>
														<a href="${pageContext.request.contextPath}/view/yy/yyUserEdit.jsp"  class="tooltip-info" data-rel="tooltip" title="编辑">
		...
		<script type="text/javascript">
			$("#submenu-menu-yy-user").addClass("active");
