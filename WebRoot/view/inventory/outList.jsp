        ...
        <div class="page-content">
            <div class="row">
                    ...
                    <div class="searchbar">
                        <ul class="list-inline">
                            ...
                            <a style="float: right" class="tooltip-info" data-rel="tooltip" title="新增">
                                <div hidden id="roleName" ></div>
                                <div id="roleFilter" hidden="hidden">
                                    <button onclick="preAddOrModifyDeliveryOrder('')" class="btn btn-xs btn-success">新增
                                    </button>
                                </div>
                                <input id="userId" type="hidden" value="${account.userId}">
                ...
                <div class="col-xs-12">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <input id="deliveryOrderId" type="hidden">
                            ...
                            <table id="out_list" class="table table-striped table-bordered table-hover"
                                ...
                                <tr>
                                    ...
                                    <th class="center">要求出库日期</th>
                                    <th class="center">实际出库日期</th>
                                    <th class="center">出库单状态</th>
                                    <th class="center">出库单明细</th>
                                ...
                                <div class="col-xs-9" style="width: 800px">
                                    <table id="agent_dtl_table"
                                        ...
                                        <tr>
                                            ...
                                            <th class="center">处理商品</th>
                                            <th class="center">处理数量</th>
                                            <th class="center">处理备注</th>
                                        </tr>
                                        </thead>
                                        <tbody>
...
<script src="${pageContext.request.contextPath}/js/biz/inventory/outList.js"></script>
<script>
    if ("${msg}" != '') {
        alert("${msg}");
    }
