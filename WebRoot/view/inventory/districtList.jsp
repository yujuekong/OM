    ...
    <div class="page-content">
      <div class="row">
        ...
        <div class="col-xs-12">
          ...
          <div class="row">
            <div class="col-xs-12">
              <input id="deliveryOrderId" type="hidden" value="${deliveryOrderId}">
              ...
              <table id="out_list" class="table table-striped table-bordered table-hover"
                ...
                <tr>
                  ...
                  <th class="center">对应仓库</th>
                  <th class="center">订单状态</th>
                  <th class="center">特勤小组</th>
                ...
                <div class="col-xs-9" style="width: 800px">
                  <table id="agent_dtl_table"
                    ...
                    <tr>
                      ...
                      <th class="center">计划出库数量</th>
                      <th class="center">实际出库数量</th>
...
<%--<script src="${pageContext.request.contextPath}/js/biz/inventory/dispatchingList.js"></script>--%>
<%--<script>--%>
<%--if ("${msg}" != '') {--%>
<%--alert("${msg}");--%>
<%--}--%>
