...
<html lang="en">
	...
	<link rel="stylesheet" href="http://api.map.baidu.com/library/SearchInfoWindow/1.5/src/SearchInfoWindow_min.css" /></link>
	...
	<body class="no-skin">
		...
		<script src="${pageContext.request.contextPath}/js/biz/car/carInfoMap.js"></script>
		<script type="text/javascript">
